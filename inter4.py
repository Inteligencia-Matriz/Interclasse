...
# =============================================================================
# Aplicação Streamlit Principal - ADAPTADA COM TABELAS INTERATIVAS
# =============================================================================
...
def main():
    ...
    # MODIFICAÇÃO PRINCIPAL 2: Usando st.data_editor para tabela interativa com checkboxes :cite[7]
    ...
    if not modalidades_filtradas.empty:
        ...
        # MODIFICAÇÃO PRINCIPAL 5: Editor de dados para modalidades :cite[7]
